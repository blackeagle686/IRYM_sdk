...
> [!TIP]
> For a deep dive into the architecture and integration patterns (CLI, Web, GUI), check out the **[Agent Framework Guide](./docs/AGENT_GUIDE.md)** or the specialized **[Django Integration Guide](./docs/DJANGO_INTEGRATION.md)**.
